<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="examcreationmaster.aspx.cs" Inherits="_Default" %>
...
<asp:Button ID="Button1" CssClass="form-control btn-primary"   runat="server" Text="save" OnClick="Button1_Click" />
                               ...
                               <asp:GridView ID="GridView1"  class="col-md-12 table" runat="server" AutoGenerateColumns="false" OnRowCancelingEdit="GridView1_RowCancelingEdit" OnRowDeleting="GridView1_RowDeleting" OnRowEditing="GridView1_RowEditing" OnRowUpdating="GridView1_RowUpdating">
            <FooterStyle BackColor="White" ForeColor="#000066" />
               ...
               <asp:TemplateField HeaderText="ID">
                ...
                <asp:TemplateField HeaderText="exam_code">
                    <ItemTemplate>
               <asp:Label ID="lbexamcode1" runat="server" Text='<%# Eval("exam_code") %>' />
                        </ItemTemplate>
                    <EditItemTemplate>
                     <%--  <asp:TextBox ID="txtxourse_code" runat="server" Width="120px" Text='<%# Eval("course_code") %>'></asp:TextBox>--%>
                        <asp:Label ID="lbcode" runat="server" Text='<%# Eval("exam_code") %>' />
                    </EditItemTemplate>
                </asp:TemplateField>
                ...
                <asp:TemplateField HeaderText="exam Name">
                   ...
                   <%# Eval("exam_name") %>
                    ...
                    <EditItemTemplate>
                      <asp:TextBox ID="txtexam_name" runat="server" Width="120px" Text='<%# Eval("exam_name") %>'></asp:TextBox>
                    </EditItemTemplate>
                </asp:TemplateField>
